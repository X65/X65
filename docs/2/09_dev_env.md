...
Both categories are built by the same compiler / assembler / linker pipeline and produce byte-identical `.xex` file structure. Only the *deployment step* and the *runtime assumptions* change, and those are covered below.
